...
This extension is composed of a Python package named `jupyter_projspec`
for the server extension and a NPM package named `jupyter-projspec`
...
# Change directory to the jupyter_projspec directory
...
folder is located. Then you can remove the symlink named `jupyter-projspec` within that folder.
